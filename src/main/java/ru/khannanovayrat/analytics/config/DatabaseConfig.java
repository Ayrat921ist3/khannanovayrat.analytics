package ru.khannanovayrat.analytics.config;
 ...
 */
@Configuration
@EnableJpaRepositories("ru.khannanovayrat.analytics.repository")
@EnableTransactionManagement
@ComponentScan("ru.khannanovayrat.analytics")
...
public class DatabaseConfig {
    ...
    private Properties getHibernateProperties() {
        try {
            ...
            throw new IllegalStateException("Can't find 'hibernate.properties' in classpath", e);
        }
    }
